...
import { defaultIntrinsicSyncAgentProviders, defaultSyncAgentProviders } from "../../../syncAgentProvider.js";
import { getSyncObjectSyncAgentProvider } from "../typedSyncAgent.js";
...
export function syncObject<This extends abstract new (...args: any) => any>(settings?: TrackableObjectSettings<InstanceType<This>>) {
  return function syncObject(target: This, context: ClassDecoratorContext<This>) {
    ...
    context.addInitializer(() => {
      const provider = getSyncObjectSyncAgentProvider(target as any);
