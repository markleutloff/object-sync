...
import { SyncableObservableMap } from "../../src/serialization/index.js";
...
describe("SyncableObservableMap Serializer", () => {
  ...
  it("should emit events on client and host", async () => {
    ...
    const destObject = destSync.findOne<SyncableObservableMap<any, any>>(SyncableObservableMap, "main")!;
