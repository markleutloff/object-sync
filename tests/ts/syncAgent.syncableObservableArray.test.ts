...
import { SyncableObservableArray } from "../../src/syncAgents/index.js";
...
describe("SyncableObservableArray Serializer", () => {
  ...
  it("should emit events on client and host", async () => {
    ...
    const destObject = destSync.rootObjects.findOne<SyncableObservableArray<any>>(SyncableObservableArray, "main")!;
